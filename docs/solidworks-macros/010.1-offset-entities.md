...
`swSkOffsetCapEndType_e` enum defines following different *End cap types* 🚀 **[constants](/vba/vba-constant)**:
...
`swSkOffsetMakeConstructionType_e` enum defines following different *Construction Types* 🚀 **[constants](/vba/vba-constant)**:
...
`swSkOffsetMakeConstructionType_e` enum defines following different 🚀 **[constants](/vba/vba-constant)**:
